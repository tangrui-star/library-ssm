...
<body>
   <div class="panel admin-panel">
       <form action="${ctx}/manageBooks/findBySql" id="listform" method="post">
       <div class="padding border-bottom">
           <ul class="search" style="padding-left: 10px;">
               <li>
                   <a class="button border-main icon-plus-square-o" href="${ctx}/manageBooks/add">添加图书</a>
               </li>
               <li>
...
<%--                   <td><fmt:formatDate value="${data.bkDateInput}" pattern="yyyy-MM-dd HH:mm:ss" /></td>--%>
                   ...
                   <td>
                       <div class="button-group">
                           <a class="button border-main" href="${ctx}/manageBooks/update?bkID=${data.bkID}"><span class="icon-edit">修改</span></a>
